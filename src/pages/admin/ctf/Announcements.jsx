    ...
    <section className="space-y-4">
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        {rows.map((row) => (
          ...
          >
            <h2 className="text-lg font-semibold text-slate-100">{row.title}</h2>
            ...
            <div className="mt-3 flex gap-2">
              <button
                ...
                className="rounded-lg border border-blue-500/40 bg-blue-500/15 px-3 py-1.5 text-xs text-blue-100 hover:bg-blue-500/25"
              >
                Edit
              </button>
              <button
                ...
                className="rounded-lg border border-rose-500/40 bg-rose-500/15 px-3 py-1.5 text-xs text-rose-100 hover:bg-rose-500/25"
              >
                Delete
              </button>
            </div>
