  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      const payload = {
        ...
        room_key: isFirstRoom ? "" : normalizedRoomKey,
  ...
  return (
    <section className="mx-auto max-w-4xl space-y-4">
      <div className="flex items-center justify-between gap-3">
        <div>
          <h1 className="text-2xl font-semibold text-slate-100">{titleText}</h1>
        ...
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <label className="space-y-1 md:col-span-2">
            ...
            <input
              ...
              className="w-full rounded-xl border border-slate-700 bg-slate-800 px-3 py-2 text-slate-100 outline-none focus:ring-2 focus:ring-blue-500/40 disabled:cursor-not-allowed disabled:opacity-60"
              placeholder={
                !isEdit && isFirstRoom
          ...
          <label className="flex items-center gap-2 rounded-xl border border-slate-700 bg-slate-800 px-3 py-2">
            ...
            />
            <span className="text-sm text-slate-200">Active room</span>
          </label>
        </div>
