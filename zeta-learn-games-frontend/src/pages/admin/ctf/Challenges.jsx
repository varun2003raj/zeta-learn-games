...
export default function CtfChallenges() {
      ...
      render: (challenge) => {
        ...
        return (
          <button
            ...
            className="rounded-md border border-blue-500/40 bg-blue-500/15 px-2 py-1 text-xs text-blue-100 hover:bg-blue-500/25"
          >
            Download
          </button>
        );
      ...
      render: (challenge) => (
        <div className="flex flex-wrap gap-2">
          <button
            ...
            className="rounded-lg border border-blue-500/40 bg-blue-500/15 px-2 py-1 text-xs text-blue-100 hover:bg-blue-500/25"
          >
            Edit
          </button>
          {isTieBreakerChallenge(challenge) ? (
            <button
              ...
              className="rounded-lg border border-violet-500/40 bg-violet-500/15 px-2 py-1 text-xs text-violet-100 hover:bg-violet-500/25"
            >
          ...
          <button
            ...
            className="rounded-lg border border-rose-500/40 bg-rose-500/15 px-2 py-1 text-xs text-rose-100 hover:bg-rose-500/25"
          >
            Delete
          </button>
        </div>
  ...
  return (
    <section className="space-y-4">
      <div>
        <h1 className="text-2xl font-semibold text-slate-100">CTF Challenges</h1>
      ...
      >
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <label className="space-y-1">
            <span className="text-sm text-slate-300">Hint Visibility</span>
            <select
          ...
          <label className="space-y-1">
            <span className="text-sm text-slate-300">Challenge File</span>
            <input
              type="file"
              onChange={(event) => setSelectedFile(event.target.files?.[0] || null)}
              className="w-full rounded-xl border border-slate-700 bg-slate-800 px-3 py-2 text-sm text-slate-200 file:mr-4 file:rounded-lg file:border-0 file:bg-blue-600 file:px-3 file:py-1.5 file:text-white hover:file:bg-blue-500"
            />
          </label>

          <label className="space-y-1 md:col-span-2">
            <span className="text-sm text-slate-300">Hint 1</span>
            <textarea
              rows={2}
              value={form.hint_1}
              onChange={(event) =>
          ...
          <label className="space-y-1 md:col-span-2">
            <span className="text-sm text-slate-300">Hint 2</span>
            <textarea
              rows={2}
              value={form.hint_2}
              onChange={(event) =>
          ...
          <label className="flex items-center gap-2 rounded-xl border border-slate-700 bg-slate-800 px-3 py-2">
            ...
            />
            <span className="text-sm text-slate-200">Active challenge</span>
          </label>
        </div>
        ...
        {editingId && currentFileUrl ? (
          <div className="rounded-xl border border-slate-700 bg-slate-800/80 p-3 text-sm text-slate-300">
            ...
            <button
              ...
              className="ml-3 rounded-md border border-blue-500/40 bg-blue-500/15 px-2 py-1 text-xs text-blue-100 hover:bg-blue-500/25"
            >
              Download
            </button>
          </div>
