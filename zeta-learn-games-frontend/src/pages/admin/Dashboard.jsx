...
const attemptColumns = [
  ...
  attempt?.completed
    ...
    : attempt?.current_level?.title || attempt?.current_level || "-",
  },
  {
    key: "score",
    title: "Score",
...
if (historyName !== "confirm") {
  toast.error("You must type 'confirm' exactly.");
  return;
}

await ctfService.resetCtf(historyName);
